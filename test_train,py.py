...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCHS):
        ...
        for i in tqdm(range(len(train_data) // BATCH_SIZE + 1),ncols = 20,desc ='train ' +  str(epoch)):
            batch = get_batch(train_data, i * BATCH_SIZE, BATCH_SIZE)
            # i += BATCH_SIZE
        ...
        with torch.no_grad():
            ...
            for i in tqdm(range(len(val_data) // BATCH_SIZE + 1),ncols = 20,desc ='val ' +  str(epoch)):
                batch = get_batch(val_data, i * BATCH_SIZE, BATCH_SIZE)
                # i += BATCH_SIZE
